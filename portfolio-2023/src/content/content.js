...
const content = {
  ...
  projects: {
    ...
    clayDescription:
      "A claymation video using different materials and textures to visually depict the sounds of an audio file",
    ...
    switchDescription:
      "A poster series advertising Make The Switch, a campaign encouraging people and businesses to switch investment from fossil fuels to renewable energy",

    // ---- New York Underground ---- //
    nyTitle: "New York Underground",
    nyDescription:
      "An infographic portraying the influences, collaborations and associations of iconic artists with New York's underground scene",
...
let webDevelopment = [
  {
    ...
    linkUrl:
      "https://www.figma.com/proto/NOd7MS2159afIwmzONSoJg/ID2-GoGarden?node-id=275-1552&scaling=scale-down&page-id=101%3A465&starting-point-node-id=275%3A1812&show-proto-sidebar=1",
    tags: [
      {
  ...
  },
  {
    ...
    linkUrl:
      "https://www.figma.com/proto/8Pmyi4VbGVsv5xdxpbaQrp/TheraPro?page-id=267%3A3922&node-id=267-4139&viewport=3044%2C4020%2C0.5&scaling=contain&starting-point-node-id=267%3A4139&show-proto-sidebar=1",
    tags: [
      {
        key: 1,
        tag: content.projects.tagUX,
...
let animation = [
  ...
  },
  {
    ...
    linkUrl:
      "https://www.behance.net/gallery/152399527/Ghost-Talent-Show-Animation",
    tags: [
      {
        key: 1,
        tag: content.projects.tag3D,
  ...
  },
  {
    ...
    linkUrl:
      "https://www.behance.net/gallery/152399035/Satellites-Ted-Talk-Animation",
    tags: [
      {
        key: 1,
  ...
  },
  {
    ...
    linkUrl:
      "https://www.behance.net/gallery/152399269/Flour-Sack-Princess-Animation",
    tags: [
      {
        key: 1,
        tag: content.projects.tag2D,
